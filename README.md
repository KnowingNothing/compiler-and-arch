...
- Open-source
    - [Triton: an intermediate language and compiler for tiled neural network computations](https://dl.acm.org/doi/10.1145/3315508.3329973) **MAPL 2019**. [Github Page](https://github.com/triton-lang/triton). [Document Page](https://triton-lang.org/main/python-api/triton.language.html). Philippe Tillet, H. T. Kung, David CoxAuthors Info & Claims. _OpenAI_
